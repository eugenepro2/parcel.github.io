              ...
              <div style="background-color:transparent;">
                <div class="block-grid" style="Margin: 0 auto; min-width: 320px; max-width: 780px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;">
                  <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                    ...
                    <!--[if (mso)|(IE)]><td align="center" width="780" style="background-color:transparent;width:780px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:30px; padding-bottom:30px;background-color:#f6f6f6;"><![endif]-->
                    <div class="col num12" style="min-width: 320px; max-width: 780px; display: table-cell; vertical-align: top; width: 780px;">
                      <div style="background-color:#f6f6f6;width:100% !important;">
                        ...
                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:30px; padding-bottom:30px; padding-right: 0px; padding-left: 0px;">
                          ...
                          <div style="color:#555555;font-family: Arial,sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                            <div style="line-height: 1.2; font-size: 14px; font-family: Arial,sans-serif; color: #555555; mso-line-height-alt: 14px;">
                              <p style="text-align: center; line-height: 1.2; font-family: Arial,sans-serif; mso-line-height-alt: NaNpx; margin: 0; font-weight: normal;">
                                Alternativ kannst du deine Registrierung über diesen Link bestätigen:<br>
                                <div align="center" style="max-width: 780px !important;">
