...
new _yaireo_tagify__WEBPACK_IMPORTED_MODULE_1___default.a(input); //Hast Du eine USt-IdNr.? *

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#8').change(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == 72) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-9').slideDown();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#9').attr('required', true);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.notify').slideUp();
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-9').slideUp();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#9').attr('required', false);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.notify').slideDown();
  }
}); // $('#27').change(function() {
//   if ($(this).val() == '54') {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#22').change(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#23").prop('selectedIndex', 0);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#23 option').attr('disabled', false);

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '1') {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#23 option:nth-of-type(2)').attr('disabled', true);
  }

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '2' || jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '3') {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#23 option:nth-of-type(3)').attr('disabled', true);
  }
}); //on Change Gewichts- & Produktauswahl *

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#23').change(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#24").prop('selectedIndex', 0);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#24 option').attr('disabled', false);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-24').slideUp();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#24').attr('required', false);

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '6') {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-24').slideDown();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#24').attr('required', true);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#25').change(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '68') {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-26,#field-27').slideDown();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-26 input, #field-27 input').attr('required', true);
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-26,#field-27').slideUp();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-26 input,#field-27 input').attr('required', false);
  }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#28').change(function () {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '74') {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#option-55').show();
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#option-54').show();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#option-55').hide();
  }
}); //Wawi/ERP System

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#29').change(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '33') {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-30').slideDown();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-30 input').attr('required', true);
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-30').slideUp();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-30 input').attr('required', false);
  }
}); //Shopsystem

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#31').change(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '46') {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-32').slideDown();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-32 input').attr('required', true);
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-32').slideUp();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-32 input').attr('required', false);
  }
}); //API-Anbindung *
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#33').change(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() == '55') {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#35').attr('required', true);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#35').attr('required', false);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-36').slideUp();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#36').attr('required', false);
  }
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.iban').click(function () {
  var iban = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#47').val();
  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
    type: "GET",
    url: "/iban/".concat(iban)
  }).done(function (data) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.notify').slideUp();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-48').slideDown();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-49').slideDown();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#48').val(data.bic);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#49').val(data.bank);
  }).fail(function (xhr, status, error) {
    if (status) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-48').slideUp();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#field-49').slideUp();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.notify').slideDown();
    }
  });
});
